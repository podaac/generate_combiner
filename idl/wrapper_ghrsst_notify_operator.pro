...
;
; This is the identical content as the PRO version.  We have to make it a function because the PRO version confuses
; the argument list when called from Perl.
