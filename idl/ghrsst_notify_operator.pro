...
;===============================================================================
;
;Module Name:   ghrsst_notify_operator
;
;Call Protocol: ghrsst_notify_operator, routine_name, msg_type, msg, email,      $
;                  sigevent, temp_dir,msg2report
;===============================================================================
;
...
;       U.S. Government Sponsorship is acknowledged. ALL RIGHTS
;       RESERVED. Any commercial use must be negotiated with the 
;       Office of Technology Transfer at the California Institute 
;       of Technology.
;
...
;Files Accessed:
;
;   None, other than input file
;
;Revision History:
;
;       SEP-10 (CKT) - initial creation
;       JAN-11 (CKT) - added SigEvent notification
;       SEP-12 (QTC) - Major modification to be used by the GHRSST project
;
;Notes:
;
;
;=============================================================================
;-
PRO ghrsst_notify_operator, routine_name, msg_type, msg, email, sigevent, temp_dir,msg2report, i_data
   ;msg2report
...
;PRINT, 'ghrsst_notify_operator: argCount = ', argCount
